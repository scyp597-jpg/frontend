...
export default function UserDashboard(){
  const [user, setUser] = useState<UserProfile>({ name: 'Guest', email: '' })
      ...
      <aside className="sidebar">
        <div style={{display:'flex',alignItems:'center',gap:12}}>
          ...
          <div>
            ...
            <div style={{fontSize:12,opacity:0.85}}>{user.email || 'Member'}</div>
          </div>
        </div>

        <nav className="side-nav">
          <Link href="/portal/user" className="side-item active">Dashboard</Link>
          <Link href="/portal/resources" className="side-item">Resources</Link>
          <Link href="/portal/news" className="side-item">News</Link>
          <Link href="/portal/events" className="side-item">Events</Link>
          <Link href="/portal/user/profile" className="side-item">Profile</Link>
        </nav>
